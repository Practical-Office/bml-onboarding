# Research: Lean Startup teaching points for BML course Modules 1–2

**Ticket:** Research Lean Startup teaching points for BML course modules (wayfinder map child)  
**Parent map:** Wayfinder: BML Mastery onboarding course (Practical-Office/bml-onboarding)  
**Repo:** [`docs/research/lean-startup-bml-teaching-points.md`](./lean-startup-bml-teaching-points.md) in `Practical-Office/bml-onboarding`  
**Date:** 2026-07-15  
**Question:** Which Lean Startup ideas (Eric Ries) should Modules 1–2 of a Practical Office BML onboarding course teach — at concept level only, no substantial book excerpts — so the course grounds Build–Measure–Learn, validated learning, and persevere/pivot/kill without copyright risk?
...
|---|---|---|
| Startups / new products under uncertainty | New products are built under **extreme uncertainty**; the hard questions are “Should we build this?” and “Can we build a sustainable business around it?” — not only “Can we ship it?” | Frames BML as learning under uncertainty, not feature factory speed. |
...
5. **Use long distinctive phrase strings** that read as book prose. Prefer ordinary paraphrases of the public concepts (BML, MVP, validated learning, pivot/persevere).
...
## Mapping to Practical AI’s BML Kanban

| Lean Startup concept | Practical AI BML Kanban / ops |
|---|---|
...
**Column reminder (from BookIQ BML handoff):** Backlog → Build → Measure → Learn / Validate → Done.
...
| Source | Role |
|---|---|
| [The Lean Startup — Methodology / Principles](https://theleanstartup.com/principles) | Primary public summary of BML, MVP, validated learning, actionable metrics, pivot/persevere |
...
| BookIQ `docs/BML/BML_Kanban_Handoff.md` + Implementation Notes | Local mapping target (Kanban columns, labels, kill path) — not a Ries primary source |
